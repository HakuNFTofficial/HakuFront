...
// ARC_DEPLOY_UPDATE: replace zero placeholders after each Arc deployment step.
export const CONTRACTS = {
    ...
    ADD_LIQUIDITY_EXECUTOR: '0x0b25f5fa975863eb3F63dfe2Ba178C3A0913c520', // AddLiquidityExecutor Proxy
    ...
    // HakuToken/HakuNFT proxy contract address
    HUKU_NFT: '0x19c02CC2118Afe3CB59bb2f777d1a1124c7A6C12',
} as const
...
export const POOL_CONFIG = {
    ...
    HOOKS: '0x17816cEaB0f956756fAcDF3E9ac02061E257c088' as `0x${string}`, // Hook address
    SQRT_PRICE_X96: '2505414483750479311832031227609', // Corresponds to 1:1000 price (1 native USDC = 1000 HakuToken)
    POOL_ID: '0xcfd5a6206498eecc604b2d9ddd9536a2be58456841d8465937652d663eb97a29' as `0x${string}`,
...
export const TRADING_PAIR_CONFIG = {
    ...
    BASE_TOKEN_SYMBOL: 'USDC',      // Arc native gas token symbol
