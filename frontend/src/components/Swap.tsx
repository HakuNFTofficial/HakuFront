...
export function Swap() {
    ...
    const tokenASymbol = ARC_NATIVE_SYMBOL
    const tokenADecimals = 18 // Arc native USDC uses 18 decimals for gas balance.
    ...
    const currentPrice = useMemo(() => {
        ...
        // In our pool: currency0 = native USDC (TOKEN_A), currency1 = TokenB.
        // So price = TokenB / native USDC.
        ...
        //     priceTokenBPerSTT,
        //     sttToTokenB: priceSTTPerTokenB,
        //     tokenBToSTT: priceTokenBPerSTT
        // })
    ...
    const quoteParams = useMemo(() => {
        ...
        // buy mode: native USDC (currency0) -> HakuToken (currency1), so zeroForOne = true
        // sell mode: HakuToken (currency1) -> native USDC (currency0), so zeroForOne = false
                            ...
                            if (errorSelector === '0xe450d38c') {
                                ...
                                try {
                                    ...
                                    if (uint256_2 > uint256_1) {
                                        ...
                                        const tokenName = mode === 'buy' ? 'HakuToken' : ARC_NATIVE_SYMBOL
            ...
            <div className="w-full bg-[#1a1b23] rounded-2xl p-4 shadow-2xl border border-gray-800">
                ...
                {address && (
                    <div className="mb-4 flex items-center justify-between">
                        {mode === 'buy' ? (
                            // Buy mode: show native USDC balance
                            <>
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="text-white text-sm font-medium">{ARC_NATIVE_SYMBOL}</div>
                                </div>
                        ...
                        <div className="mt-2 px-4 py-3 bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg border border-blue-700/50">
                            ...
                            <div className="text-white text-sm space-y-1">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="font-mono font-semibold">{parseFloat(amount).toFixed(4)} {mode === 'buy' ? ARC_NATIVE_SYMBOL : 'HakuToken'}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-gray-400">≈ You will receive:</span>
                                    <span className="font-mono font-semibold text-green-400">{quoteInfo.amountOutFloat.toFixed(4)} {mode === 'buy' ? 'HakuToken' : ARC_NATIVE_SYMBOL}</span>
                                </div>
                ...
                <div className="flex gap-2 mb-6">
                    ...
                    {(() => {
                        ...
                        if (mode === 'buy') {
                            // Buy mode: use native USDC balance
